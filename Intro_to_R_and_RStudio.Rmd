...
```{r Exercise 3.4}
name <- "Alexis"  #charcater
typeof(name)
age <- 20 #double
typeof(age)
birthday <- "04/29/2003" #character
typeof(birthday)
three_fav_colors <- "Brown, Black, and Blue" #character
...
```{r Exercise 5.1}
"QBIO" == "QBIO" ## is equal to TRUE
"USC" != "UCLA" ## is not equal to TRUE
10 > 9 ## greater than TRUE
1 < 2 ## less than TRUE
8 >= 3 ## greater than or equal to TRUE
4 <= 7 ## less than or equal to TRUE
100 %in% c(10, 100, 1000, 10000) ## is present in a vector/list TRUE
```
